...
class BaselineNLPFlow(FlowSpec):
    ...
    def baseline(self):
        ...
        self.valdf['preds']= [1] * self.valdf.shape[0]
    ...
    def end(self):
        ...
        false_positives = self.valdf.loc[(self.valdf['preds'] == 1) & (self.valdf['label'] == 0)]
        current.card.append(Table.from_dataframe(false_positives))
        
        current.card.append(Markdown("## Examples of False Negatives"))
        false_negatives = self.valdf.loc[(self.valdf['preds'] == 0) & (self.valdf['label'] == 1)]
        current.card.append(Table.from_dataframe(false_negatives))
